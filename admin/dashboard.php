...
<head>
    ...
    <style>
        ...
        .dropdown-menu a:hover {
            ...
            /* A slightly darker light yellow for hover */
            color: #333;
        ...
        #animated-image {
            ...
            /* Sets the scaling center to the image center */
        }
...
<body style="background-color: #f5f5dc;">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color:#f8f88f;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" style="color: #f9d8d8; font-size:13px;" href="?stock=1">Stock</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: #f9d8d8; font-size:13px;" href="?donors=1">Donors</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: #f9d8d8; font-size:13px;" href="?patients=1">Patients</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: #f9d8d8; font-size:13px;" href="?donations=1">Donations</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: #f9d8d8; font-size:13px;" href="?requests=1">Requests</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: #f9d8d8; font-size:13px;"
                            href="?donations_history=1">Donations History</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: #f9d8d8; font-size:13px;" href="?requests_history=1">Requests
                            History</a>
                    </li>
                    <li>
                        <?php
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li>
                                <a class="dropdown-item" style="color: #000000; font-size:13px;" href="?logout=1">Logout</a>
                            </li>
                        </ul>
                    </div>
                    ';
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4"> 
                <div class="card transparent-bg" style="background:#1abc9c;border:none;border-radius:16px;">
                    <div class="card-body">
                        ...
                        <img src="' . $row['image'] . '" alt="Donation Image" class="donation-image">
    ...
    if ($getOne && $getOne === 'profile') {
        ...
        if (!isset($_SESSION["welcome_admin_message"]) && isset($_SESSION["admin"])) {
            ...
            echo '
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        Swal.fire({
                            title: "Welcome, ' . htmlspecialchars($_SESSION["admin"]) . '!",
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            // Displaying request details (you may have your own implementation here)
            requests_donations_details($row, "request.php", "Contact", "reason");
        ...
        if ($cnt == 0)
            print_error("No requests made currently!");
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            requests_donations_details($row, "donate.php", "Contact", "disease");
        ...
        if ($cnt == 0)
            print_error("No donations made currently!");
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            history($row, "patient_id", "Contact", "reason");
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            history($row, "donor_id", "Contact", "disease");
        ...
        if ($cnt == 0)
            print_error("No donations history!");
